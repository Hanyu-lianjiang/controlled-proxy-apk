...
object AppConfig {
    ...
    const val APP_URL = "$GITHUB_URL/Hanyu-lianjiang/controlled-proxy-apk"
    const val APP_API_URL = "https://api.github.com/repos/Hanyu-lianjiang/controlled-proxy-apk/releases"
